          ...
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '48px' }}>
              ...
              <h2 style={{ fontSize: '40px', fontWeight: '800', marginBottom: '16px' }}>
                Find Your Ideal Mobility Solution
              </h2>
              <p style={{ color: 'var(--text-muted)' }}>
                Scope out your custom charging and electric transport needs using our step-by-step assistant.
              </p>
            </div>
              ...
              <div style={{ padding: '48px' }}>
                {!wizardCompleted ? (
                  <form onSubmit={handleWizardSubmit}>
                    ...
                    {wizardStep === 1 && (
                      <div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
                          {['Industrial Facility', 'Educational Institution', 'Commercial Campus', 'Government Agency', 'Hospital Complex', 'Hotel & Resort'].map((ind) => (
                            <button
                              key={ind}
                              type="button"
                              onClick={() => {
                    ...
                    {/* Step 2: Mobility Requirement */}
                    {wizardStep === 2 && (
                      <div>
                        <h3 style={{ fontSize: '22px', fontWeight: '700', marginBottom: '28px' }}>
                          What is your primary infrastructure requirement?
                        </h3>
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
                          {['Utility Transportation', 'Charging Stations Grid', 'Enterprise Fleet Setup', 'Campus Shuttle Loops', 'Industrial Load Shuttles'].map((req) => (
                            <button
                              key={req}
                              type="button"
                              onClick={() => {
                    ...
                    {wizardStep === 3 && (
                      <div>
                        <h3 style={{ fontSize: '22px', fontWeight: '700', marginBottom: '28px' }}>
                          Projected electric utility vehicle fleet size:
                        </h3>
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
                          {[
                            { label: 'Small (< 5 Vehicles)', val: 'Small' },
                            { label: 'Medium (5 - 15 Vehicles)', val: 'Medium' },
                            { label: 'Large (15 - 50 Vehicles)', val: 'Large' },
                            { label: 'Enterprise (> 50 Vehicles)', val: 'Enterprise' }
                          ].map((qty) => (
                            <button
                              key={qty.val}
                              type="button"
                              onClick={() => {
                                setWizardData(prev => ({ ...prev, fleetSize: qty.val }));
                                handleNextStep();
                              }}
                              style={{
                                padding: '20px',
                                border: wizardData.fleetSize === qty.val ? '2px solid var(--primary)' : '1px solid var(--border-color)',
                                backgroundColor: wizardData.fleetSize === qty.val ? 'rgba(31, 93, 55, 0.03)' : '#FFFFFF',
                                borderRadius: '14px',
                                color: 'var(--text-dark)',
                                fontWeight: '600',
                                fontSize: '15px',
                    ...
                    {/* Step 4: Charging Requirement */}
                    {wizardStep === 4 && (
                      <div>
                        <h3 style={{ fontSize: '22px', fontWeight: '700', marginBottom: '28px' }}>
                          What is your preferred charging capability?
                        </h3>
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
                          {['Standard AC (Slow / Overnight)', 'DC Fast Charging (30 - 60 Min)', 'Solar-Integrated Storage (BESS)', 'Technical Consultation'].map((g) => (
                            <button
                              key={g}
                              type="button"
                              onClick={() => {
                                setWizardData(prev => ({ ...prev, charging: g }));
                                handleNextStep();
                              }}
                              style={{
                                padding: '20px',
                                border: wizardData.charging === g ? '2px solid var(--primary)' : '1px solid var(--border-color)',
                                backgroundColor: wizardData.charging === g ? 'rgba(31, 93, 55, 0.03)' : '#FFFFFF',
                                borderRadius: '14px',
                                color: 'var(--text-dark)',
                                fontWeight: '600',
                                fontSize: '15px',
                    ...
                    {wizardStep === 5 && (
                      <div>
                        <h3 style={{ fontSize: '22px', fontWeight: '700', marginBottom: '28px' }}>
                          Submit details to finalize your technical design:
                        </h3>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '24px' }}>
                          ...
                          <div>
                            ...
                            <input 
                              ...
                              placeholder="e.g. robert@titan.com"
                              style={{ width: '100%', padding: '14px', border: '1px solid var(--border-color)', borderRadius: '10px', fontSize: '15px' }}
                            />
                          </div>
                  ...
                  <div style={{ textAlign: 'center', padding: '24px 0' }}>
                    ...
                    <p style={{ color: 'var(--text-muted)', fontSize: '16px', maxWidth: '500px', margin: '0 auto 32px', lineHeight: '1.6' }}>
                      Thank you, <strong>{wizardData.name}</strong>. Our engineering leads are analyzing your fleet requirements for <strong>{wizardData.company}</strong>. We will send the full estimation sheet to <strong>{wizardData.email}</strong> shortly.
                    </p>
                    ...
                    <div style={{
                      ...
                      <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '14px' }}>
                        ...
                        <li><strong>Projected Fleet Size:</strong> {wizardData.fleetSize}</li>
                        <li><strong>Charging Level:</strong> {wizardData.charging}</li>
                    ...
                    <button 
                      ...
                      onClick={() => {
                        ...
                        setWizardStep(1);
                        setWizardData({ orgType: '', requirement: '', fleetSize: '', charging: '', name: '', company: '', phone: '', email: '', city: '' });
                      }}
