...
export default function BiogasPage({ onNavigate }) {
  ...
  return (
    <div style={{ backgroundColor: '#FFFFFF', overflow: 'hidden' }}>
      ...
      {/* SECTION 9 — PROJECT CONSULTANT */}
      <section id="consultant" style={{ padding: '140px 0', backgroundColor: 'var(--bg-secondary)' }}>
        <div className="container">
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '48px' }}>
              ...
              <h2 style={{ fontSize: '40px', fontWeight: '800', marginBottom: '16px' }}>
                Find the Right Waste-to-Energy Solution
              </h2>
              <p style={{ color: 'var(--text-muted)' }}>
                Tell us about your organization's waste profile for a customized engineering recommendation.
              </p>
            </div>
                ...
                {!wizardCompleted ? (
                  <form onSubmit={handleWizardSubmit}>
                    ...
                    {wizardStep === 1 && (
                      <div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
                          {['Hotels & Resorts', 'Hospitals & Clinics', 'Manufacturing Industry', 'Colleges & Schools', 'Municipality', 'Agriculture & Livestock'].map((ind) => (
                            <button
                              key={ind}
                              type="button"
                              onClick={() => {
                                setWizardData(prev => ({ ...prev, industry: ind }));
                                handleNextStep();
                              }}
                              style={{
                                padding: '20px',
                                border: wizardData.industry === ind ? '2px solid var(--primary)' : '1px solid var(--border-color)',
                                backgroundColor: wizardData.industry === ind ? 'rgba(31, 93, 55, 0.03)' : '#FFFFFF',
                                borderRadius: '14px',
                                color: 'var(--text-dark)',
                                fontWeight: '600',
                                fontSize: '15px',
                    ...
                    {wizardStep === 2 && (
                      <div>
                        <h3 style={{ fontSize: '22px', fontWeight: '700', marginBottom: '28px' }}>
                          What is your primary organic waste stream?
                        </h3>
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
                          {['Food Waste / Kitchen Residuals', 'Organic Crop Residue', 'Cow Dung / Animal Manure', 'Mixed Commercial Bio-Waste'].map((wt) => (
                            <button
                              key={wt}
                              type="button"
                              onClick={() => {
                                setWizardData(prev => ({ ...prev, wasteType: wt }));
                                handleNextStep();
                              }}
                              style={{
                                padding: '20px',
                                border: wizardData.wasteType === wt ? '2px solid var(--primary)' : '1px solid var(--border-color)',
                                backgroundColor: wizardData.wasteType === wt ? 'rgba(31, 93, 55, 0.03)' : '#FFFFFF',
                                borderRadius: '14px',
                                color: 'var(--text-dark)',
                                fontWeight: '600',
                                fontSize: '15px',
                    ...
                    {/* Step 3: Daily Waste Quantity */}
                    {wizardStep === 3 && (
                      <div>
                        <h3 style={{ fontSize: '22px', fontWeight: '700', marginBottom: '28px' }}>
                          Approximate daily organic waste quantity generated:
                        </h3>
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
                          {[
                            { label: 'Small (< 100 kg/day)', val: 'Small' },
                            { label: 'Medium (100 - 500 kg/day)', val: 'Medium' },
                            { label: 'Large (500 - 2,000 kg/day)', val: 'Large' },
                            { label: 'Enterprise (> 2,000 kg/day)', val: 'Enterprise' }
                          ].map((qty) => (
                            <button
                              key={qty.val}
                              type="button"
                              onClick={() => {
                                setWizardData(prev => ({ ...prev, quantity: qty.val }));
                                handleNextStep();
                              }}
                              style={{
                                padding: '20px',
                                border: wizardData.quantity === qty.val ? '2px solid var(--primary)' : '1px solid var(--border-color)',
                                backgroundColor: wizardData.quantity === qty.val ? 'rgba(31, 93, 55, 0.03)' : '#FFFFFF',
                                borderRadius: '14px',
                                color: 'var(--text-dark)',
                                fontWeight: '600',
                                fontSize: '15px',
                    ...
                    {wizardStep === 4 && (
                      <div>
                        <h3 style={{ fontSize: '22px', fontWeight: '700', marginBottom: '28px' }}>
                          What is your primary environmental or utility goal?
                        </h3>
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
                          {['Renewable Thermal Fuel (LPG Saving)', 'Maximum Waste Volume Reduction', 'Upgraded Bio-CNG / Bottling', 'General Engineering Consultation'].map((g) => (
                            <button
                              key={g}
                              type="button"
                              onClick={() => {
                                setWizardData(prev => ({ ...prev, goal: g }));
                                handleNextStep();
                              }}
                              style={{
                                padding: '20px',
                                border: wizardData.goal === g ? '2px solid var(--primary)' : '1px solid var(--border-color)',
                                backgroundColor: wizardData.goal === g ? 'rgba(31, 93, 55, 0.03)' : '#FFFFFF',
                                borderRadius: '14px',
                                color: 'var(--text-dark)',
                                fontWeight: '600',
                                fontSize: '15px',
                    ...
                    {wizardStep === 5 && (
                      <div>
                        <h3 style={{ fontSize: '22px', fontWeight: '700', marginBottom: '28px' }}>
                          Submit your contact details for recommendation review:
                        </h3>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '24px' }}>
                          ...
                          <div>
                            <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', color: 'var(--text-dark)', marginBottom: '8px' }}>Company</label>
                            <input 
                              type="text" 
                              required
                  ...
                  <div style={{ textAlign: 'center', padding: '24px 0' }}>
                    ...
                    <h3 style={{ fontSize: '26px', fontWeight: '800', marginBottom: '16px' }}>
                      Profile Scoped Successfully!
                    </h3>
                    <p style={{ color: 'var(--text-muted)', fontSize: '16px', maxWidth: '500px', margin: '0 auto 32px', lineHeight: '1.6' }}>
                      Thank you, <strong>{wizardData.name}</strong>. Our environmental engineering team is reviewing your organic waste profile for <strong>{wizardData.company}</strong>. We will contact you at <strong>{wizardData.email}</strong> shortly.
                    </p>
                    ...
                    <div style={{
                      ...
                      <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '14px' }}>
                        <li><strong>Sector:</strong> {wizardData.industry}</li>
                        <li><strong>Feedstock:</strong> {wizardData.wasteType}</li>
                        <li><strong>Daily Loading:</strong> {wizardData.quantity}</li>
                        <li><strong>Primary Metric:</strong> {wizardData.goal}</li>
                    ...
                    <button 
                      ...
                      onClick={() => {
                        ...
                        setWizardStep(1);
                        setWizardData({ industry: '', wasteType: '', quantity: '', goal: '', name: '', company: '', phone: '', email: '', city: '' });
                      }}
